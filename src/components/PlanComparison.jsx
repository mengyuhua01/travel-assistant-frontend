...
import { Modal, Button, Typography, Row, Col, Card, Tag, Space } from 'antd';
    ...
    return (
      <div className="comparison-section">
        <div className="section-header">
          ...
          {hasChanged && <Tag color="orange" size="small">已更新</Tag>}
          <Button
            type="text"
            size="small"
            icon={<EyeOutlined />}
          ...
          <Row gutter={16} className="comparison-content">
            ...
            <Col span={12}>
              <Card
                size="small"
                title="新方案"
                className={`comparison-card ${hasChanged ? 'updated' : 'unchanged'}`}
                headStyle={{
                  backgroundColor: hasChanged ? '#f6ffed' : '#f5f5f5',
                  borderBottom: hasChanged ? '1px solid #b7eb8f' : '1px solid #d9d9d9'
                }}
              >
                <div className="plan-content">
                  <div className="activity-info">
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <div className="cost-item">
              ...
              <div className={`cost-value ${costDiff > 0 ? 'increase' : costDiff < 0 ? 'decrease' : ''}`}>
                {costDiff > 0 ? '+' : ''}¥{costDiff}
              </div>
            </div>
          </Col>
  ...
  return (
    ...
    >
      <div className="comparison-container">
        ...
        {renderTimeSection('上午活动', originalData.morning, newData.morning, <FaSun />, 'morning')}
        {renderTimeSection('下午活动', originalData.afternoon, newData.afternoon, <FaCloudSun />, 'afternoon')}
        {renderTimeSection('晚上活动', originalData.evening, newData.evening, <FaMoon />, 'evening')}
        {renderTimeSection('住宿安排', originalData.accommodation, newData.accommodation, <FaBed />, 'accommodation')}
        {renderTimeSection('交通安排', originalData.transportation, newData.transportation, <FaBus />, 'transportation')}
